        ...
        subsections : [
            {
                ...
                content :
                    <div>
                        ...
                        <p>
                            When defining a production function (See Section 5.2 Production Functions), one can choose
                            to
                            assign a return value to the function. After the function is executed and the return
                            statement is
                            reached, the return expression will be evaluated, and its value will be substituted in place
                            of the
                            original function call if the function was called within an expression. A return statement
                            consists
                        ...
                        <p>
                            ...
                            condition is met. This is useful for when you need to perform the same action multiple times,
                            perhaps with some small change between each iteration of the action. A while statement consists
                            of the <code>while</code> keyword, an open parenthesis <code>(</code>, a conditional expression, a closed parenthesis <code>)</code>,
                            an open brace <code>&#123;</code>, a series of statements, followed by a closed brace <code>&#125;</code>.
                        </p>
                        <p>
                        ...
                        <p>
                            In the event that the while loop is entered and the statements inside the braces are executed,
